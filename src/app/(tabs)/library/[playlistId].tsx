...
import { PlaylistEmptyState } from '@/components/features/Playlist/PlaylistEmptyState';
import { PlaylistSkeleton } from '@/components/features/Playlist/PlaylistSkeleton';
import { playlistScreenStyles as styles } from '@/components/features/Playlist/PlaylistScreen.styles';
import SongListCard from '@/components/features/Playlist/SongListCard';
import AnimatedPressable from '@/components/ui/AnimatedPressable';
import { MusicOptionsDrawer } from '@/components/ui/MusicOptionsDrawer';
import { useConfirm } from '@/hooks/useConfirm';
import { useBottomSheet } from '@/hooks/useDrawer';
import { useMusic } from '@/hooks/useMusic';
import { useToast } from '@/hooks/useToast';
import { theme } from '@/theme';
import { createLibrarySongActions } from '@/utils/songsActions';
...
import { getBaseColor, ImageColorsResult, pickHeroGradientFromImageColors, useBackgroundGradient } from '@/features/collections/hooks/useBackgroundGradients';
...
export default function PlaylistScreen() {
    ...
    const { imageColors } = useBackgroundGradient(playlist?.thumbnailUrl?.[0] ?? '');
