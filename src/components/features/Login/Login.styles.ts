...
export const styles = StyleSheet.create({
  ...
  forgotText: { color: theme.colors.textSecondary, fontSize: 12 },
  loginBtnContainer: { width: '100%', marginBottom: 32 },
  loginBtn: { height: 56, borderRadius: theme.radius.full, justifyContent: 'center', alignItems: 'center' },
  loginBtnDisabled: { opacity: 0.7 },
  loginBtnText: { color: 'black', fontSize: 16, fontWeight: '700', letterSpacing: 1 },
