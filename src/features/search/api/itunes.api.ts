...
import { formatDuration, upgradeArtwork, extractYear } from '../utils/itunesHelpers';

const ITUNES_BASE_URL = 'https://itunes.apple.com/search';

export const searchItunes = async (query: string, signal?: AbortSignal): Promise<CleanedSearchResult[]> => {
